#!/usr/bin/env bash
# Vendored from agentspace-so/agent-skills, gpt-image-2/scripts/gen.sh (MIT
# License). Source: https://github.com/agentspace-so/agent-skills/tree/main/gpt-image-2
# Copied in so article-image has no runtime dependency on the gpt-image-2
# skill being separately installed — only on the codex CLI itself.
#
